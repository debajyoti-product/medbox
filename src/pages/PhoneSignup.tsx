              ...
              <CarouselContent>
                ...
                text: "Track Medication Courses Regularly"
                    ...
                    <div className="w-full flex flex-col items-center justify-center">
                      <img src={item.image} alt={item.text} className="w-48 h-auto bg-background border-primary-foreground object-cover" />
        ...
        <div className="flex-1 flex flex-col justify-center space-y-6">
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <Input id="phone" type="tel" placeholder="Enter Your 10-Digit Mobile Number" value={phone} onChange={e => setPhone(e.target.value.replace(/\D/g, "").slice(0, 10))} className="h-12 rounded-xl placeholder:text-muted-foreground/40 bg-card border-border flex-1" maxLength={10} />
            </div>
          </div>
        </div>
